...
function switchMode(){
    if (night === false){
        ...
        document.querySelectorAll('.hamburger > videos__item-descr').forEach(item => {
            item.style.color ='#fff';
        });

        document.querySelectorAll('.hamburger > videos__item-views').forEach(item => {
            item.style.color ='#fff';
        });
...
function load(){
    gapi.client.init({
        'apiKey': 'AIzaSyBOK4wZs0Zz7RxWWaX6xsMcoTWW0OnHFZU',
...
//AIzaSyBOK4wZs0Zz7RxWWaX6xsMcoTWW0OnHFZU
